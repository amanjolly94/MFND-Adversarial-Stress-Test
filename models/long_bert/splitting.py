...
def add_special_tokens_at_beginning_and_end(input_id_chunks: [Tensor], mask_chunks: [Tensor]) -> None:
    """
...
def add_padding_tokens(input_id_chunks: [Tensor], mask_chunks: [Tensor]) -> None:
...
def stack_tokens_from_all_chunks(input_id_chunks: [Tensor], mask_chunks: [Tensor]) -> (Tensor, Tensor):
...
def split_overlapping(tensor: Tensor, chunk_size: int, stride: int, minimal_chunk_length: int) -> [Tensor]:
