...
from .utils.string import words_from_text, FlairTokenizer, flair_tag, zip_flair_result
...
class AttackResult(ABC):
    ...
    def __init__(self, attacked_text, raw_output, output, goal_status, score, ground_truth_output):
